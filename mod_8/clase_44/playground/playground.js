...
Nos dimos cuenta que dentro del documento HTML, un título quedó con errores de ortografía. 
Actualmente dice: Vienbenidos a mi zitio Wet.


Nuestra misión será ajustar el texto de este título y corregir este "horror" ortográfico. 
Tengamos presente que el título tiene el nombre de clase "title" y lo queremos guardar 
dentro de la variable "horrorOrtografico". Adicionalmente esperamos que las 
palabras “sitio web” queden en cursiva (<em>).
 */
...
Tenemos un listado de items (<li>) y sabemos que a algunos de ellos se les asignó un nombre de 
clase que no debería estar ahí. El nombre de clase errado es: alert-danger. Y lo que necesitamos 
es remover este nombre de clase y asignar el correcto que es: alert-success.


Importante: no todos los <li> tienen este nombre de clase errado, por lo que antes de aplicar 
el nombre de clase correcto, necesitamos saber si ese <li> tiene o no el nombre de clase alert-danger.
